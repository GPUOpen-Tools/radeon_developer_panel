...
copyright = u'2017-' + build_year + ', Advanced Micro Devices, Inc. All rights reserved.'
...
htmlhelp_basename = 'RadeonDeveloperPaneldoc'
...
latex_documents = [
    (master_doc, 'RadeonDeveloperPanel.tex', u'Radeon Developer Panel Documentation',
